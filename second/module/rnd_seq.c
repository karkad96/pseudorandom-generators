...
{
	static int figure = 0; 
	static int cache_x_i[2048 + 1] = {0};
	static int cache_x_i_den[2048 + 1] = {0};

	int i;
	int x_i = 0;
	int x_i_den = 1;
	int count = generate_random_number() % (1 << 11) + 1;
...
void LCG(char* output_str)
{
	...
	if(figure % 512 == 0)
	{
        	m = generate_random_number()  % (1 << 15) + (1 << 10);
        	a = generate_random_number()  % (1 << 15) + 1;
        	c = generate_random_number()  % (1 << 15) + 1;
        	x0 = generate_random_number() % (1 << 15) + 1;
